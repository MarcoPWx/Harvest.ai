...
Hands-on lab for the AIService (src/lib/ai/service.ts): fallback chain, caching, basic cost/quality scoring, and error classes. Pairs with unit tests in src/lib/ai/**tests**/service.test.ts.
