...
<div style={{ display: 'flex', gap: 8, marginBottom: 12 }}>
  <a href="?path=/docs/labs-index--docs&globals=presenterGuide:true&presenter=labs" style={{
    textDecoration: 'none',
  ...
  <span style={{ fontSize: 12, color: '#555' }}>Hotkey: press g then g to toggle, Esc to close</span>
</div>
