...
Explore the auth service layer and session semantics in a mock‑first environment. Pair with service tests in src/services/auth/**tests**/.
...
- Read the tests in src/services/auth/**tests**/AuthService.test.ts
